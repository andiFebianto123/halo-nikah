...
return array(
    ...
    */
    'root_script' => array(
        ...
        'local' => env('APP_URL').'/vendor/php-flasher/flasher/Resources/assets/flasher.min.js',
    ),
    ...
    */
    'styles' => array(
        ...
        'local' => env('APP_URL').'/vendor/php-flasher/flasher/Resources/assets/flasher.min.css',
    ),
