                                            ...
                                            <div class="row g-3" method="POST" action="{{ url($crud->url.'/create') }}" enctype="multipart/form-data">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="email" class="form-control slug-title" name="email" value="{{ old('email') }}" id="email">
                                                        @error('email')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="phone" value="{{ old('phone') }}" id="phone">
                                                        @error('phone')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="sm_instagram" value="{{ old('sm_instagram') }}" id="sm_instagram">
                                                        @error('sm_instagram')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="sm_whatsapp" value="{{ old('sm_whatsapp') }}" id="sm_whatsapp">
                                                        @error('sm_whatsapp')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="sm_facebook" value="{{ old('sm_facebook') }}" id="sm_facebook">
                                                        @error('sm_facebook')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="sm_twitter" value="{{ old('sm_twitter') }}" id="sm_twitter">
                                                        @error('sm_twitter')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="youtube_url_1" value="{{ old('youtube_url_1') }}" id="youtube_url_1">
                                                        @error('youtube_url_1')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="youtube_url_2" value="{{ old('youtube_url_2') }}" id="youtube_url_2">
                                                        @error('youtube_url_2')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="youtube_url_3" value="{{ old('youtube_url_3') }}" id="youtube_url_3">
                                                        @error('youtube_url_3')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control slug-title" name="youtube_url_4" value="{{ old('youtube_url_4') }}" id="youtube_url_4">
                                                        @error('youtube_url_4')
                                                            <p class="msg-error">{{ $message }}</p>
                                                        @enderror
                                                    </div>
...
@push('scripts')
	...
	<script>
        ...
        var id_province = "{{ old('province') }}";
        var id_city = "{{ old('city') }}";
