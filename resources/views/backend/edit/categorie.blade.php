                                            ...
                                            <div class="avatar-upload">
                                                ...
                                                <div class="avatar-preview ec-preview">
                                                    <div class="imagePreview ec-div-preview">
                                                        @if ($item->image)
                                                            <img src="{{ url('storage/images/permalink/'.$item->image) }}" class="ec-image-preview">
                                                        @else
                                        ...
                                        <div class="row g-3">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control slug-title" value="{{ old('name', $item->name) }}" name="name" id="name">
                                                    @error('name')
                                                         <p class="msg-error">{{ $message }}</p>
                                                    @enderror
                                                </div>
